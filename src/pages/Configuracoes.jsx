...
import {
  ...
  Phone, Mail, MapPin, FileText, Globe, Image
} from 'lucide-react';

export default function Configuracoes() {
  const { empresaAtual, selecionarEmpresa } = useAuth();
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6">
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-2">PNG, JPG ou SVG. Máximo 2MB.</p>
            <p className="text-xs text-slate-400">Recomendado: 200×200px ou maior.</p>
          </div>
          <input
            ref={fileInputRef}
            type="file"
